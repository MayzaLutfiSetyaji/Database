...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Mar 2025 pada 06.42
...
INSERT INTO `gaji_pegawai` (`gol`, `gaji_pokok`) VALUES
(1, 1500000),
(2, 2000000),
(3, 3500000),
(4, 5000000);
...
('002', 'Amin Imsyorri', '1989-12-02', 'Ciamis', '2009', 2),
...
--
ALTER TABLE `pegawai`
  ADD CONSTRAINT `pegawai_ibfk_1` FOREIGN KEY (`gol`) REFERENCES `gaji_pegawai` (`gol`);
COMMIT;
